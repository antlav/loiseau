...
public class SuivieCommande extends javax.swing.JFrame {
    ...
    String GETOPTION = "SELECT * FROM loiseaudb.option";
    ...
    String GETPRIXTRADITONNEL = "SELECT * FROM prix_traditionnel";
    ...
    private void initComponents() {
        ...
        itemEtatPrecedent = new javax.swing.JMenuItem();
        ...
        itemListe = new javax.swing.JMenuItem();
        ...
        txtCommercial.setTabLayoutPolicy(javax.swing.JTabbedPane.SCROLL_TAB_LAYOUT);
        ...
        txtMetreur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        ItemSuprCommande.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ItemSuprCommandeActionPerformed(evt);
            }
        });
        ...
        itemEtatPrecedent.setLabel("Etat précédent");
        itemEtatPrecedent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemEtatPrecedentActionPerformed(evt);
            }
        });
        jMenu1.add(itemEtatPrecedent);
        ...
        itemListe.setText("Feuille de mesure");
        itemListe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemListeActionPerformed(evt);
            }
        });
        jMenu4.add(itemListe);
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtCommercial, javax.swing.GroupLayout.Alignment.TRAILING)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jTabbedPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtCommercial, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(42, 42, 42)
                        .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            while (rs.next()) {
                uneOption = new Option(rs.getInt("id_option"), rs.getString("nom_option"), Double.parseDouble(rs.getString("prix_option")));
            ...
            while (rs.next()) {
                ...
                if (lesPrixCalypso.containsKey(Double.parseDouble(rs.getString("hauteur")))) {
                    ...
                    prixEtMoteur.add(rs.getString("puissance_moteur"));
    ...
    private void itemAjoutOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemAjoutOptionActionPerformed
        ...
        if (tblArticle.getSelectedRow() != -1) {
            unArticle = JDialogOptions.openForm(this, tblArticle.getValueAt(tblArticle.getSelectedRow(), 0).toString(),
                    tblArticle.getValueAt(tblArticle.getSelectedRow(), 2).toString(), tblArticle.getValueAt(tblArticle.getSelectedRow(), 1).toString(), lesOption);
            if (unArticle != null) {
                article.add(unArticle);
                afficherArticle();
                calculTva();
            ...
            if (refUtiliser) {
                ...
                if (lstClient.isSelectionEmpty()) {
                    ...
                    if (txtRef.getText().isEmpty()) {
                        ...
                        idClient = lesClient.get(lstClient.getSelectedIndex()).getId_client();
                        uneCommande = new Commande();
                        remplirCommande();
                        uneCommande.setEtat_commande(1);
    ...
    private void itemPriseMesurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemPriseMesurActionPerformed
        ...
        try {
            ExportExcel.exportPriseMesure(unClient, uneCommande);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "erreur dans l'importation");
        }
    ...
    private void ItemPrestaPoseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemPrestaPoseActionPerformed
        ...
        try {
            ExportExcel.exportPrestationPose(unClient, uneCommande, articleLoiseau);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex);
        }
    }//GEN-LAST:event_ItemPrestaPoseActionPerformed

    private void txtMetreurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMetreurActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMetreurActionPerformed

    private void ItemSuprCommandeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemSuprCommandeActionPerformed
        // TODO add your handling code here:
        int index = -1;
        if (tblArticle.getSelectedRow() != -1) {
            if (tblArticle.getSelectedRow() < article.size()) {
    ...
    }//GEN-LAST:event_ItemSuprCommandeActionPerformed
    ...
    private void itemEtatPrecedentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemEtatPrecedentActionPerformed
        // TODO add your handling code here:
        if (lstCommande.isSelectionEmpty()) {
            JOptionPane.showMessageDialog(this, "selectionner une commande");
        } else {
            ...
            for (Commande c : lesCommandes) {
                if (c.getRef_dossier().compareToIgnoreCase(txtRef.getText()) == 0) {
                    if (c.getEtat_commande() > 1) {
                        ...
                        JOptionPane.showMessageDialog(this, "Vous ne pouvez pas revenir plus en arriére");
                    }
                }
            }

        }
    }//GEN-LAST:event_itemEtatPrecedentActionPerformed

    private void itemListeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemListeActionPerformed
        // TODO add your handling code here:
        Vector<Vector> lesArticles = new Vector<>();
        Vector<String> unArt = new Vector<>();
        lesArticles = ImportMesures.openForm(this);
        for (Vector<String> v : lesArticles) {
            if (v.get(0).compareTo("Axe") == 0) {
                unArticleCommande = JDialogAxeFeuille.openForm(this, lesPieces, v);
                if (unArticleCommande != null) {
                    articleLoiseau.add(unArticleCommande);
                    afficherArticle();
                    calculTva();
            ...
            if (v.get(0).compareTo("Mozart") == 0 || v.get(0).compareTo("Calypso") == 0 || v.get(0).compareTo("Traditionnel") == 0) {
                unArticleCommande = JDialogVoletLoiseauFeuille.openForm(this, lesTypeArticle, lesCoulisses, lesLames, lesPoses, lesManoeuvres, lesCouleurs, v);
                if (unArticleCommande != null) {
                    try {
                        unArticleCommande = CalculPrixLoiseau(unArticleCommande);
                    } catch (Exception ex) {
            ...
            if (v.get(0).compareTo("Garage reno") == 0 || v.get(0).compareTo("Anti tempete") == 0) {
                unArticleCommande = JDialogGarageFeuille.openForm(this,v);
                if (unArticleCommande != null) {
                    if (unArticleCommande.getNom().regionMatches(true, 0, "porte", 0, 4)) {
                        try {
                            unArticleCommande = calculPrixGarageAntiTempete(unArticleCommande);
    ...
    }//GEN-LAST:event_itemListeActionPerformed
    ...
    public void completerCommande(int index) {
        ...
        txtDatePose.setText(lesCommandes.get(index).getDate_pose());
        txtDelai.setText(lesCommandes.get(index).getDelais_prevu());
        txtMetreur.setText(lesCommandes.get(index).getTemps_pose_moeteur());
        txtTmpCommercial.setText(lesCommandes.get(index).getTemps_pose_commercial());
        txtVendu.setText(lesCommandes.get(index).getTemps_pose_vendu());
        txtReglement.setText(lesCommandes.get(index).getType_reglement());
    ...
    private javax.swing.JMenuItem itemEtatPrecedent;
    private javax.swing.JMenuItem itemListe;
