 ...
 * @author guillaume
 */
public class JDialogVoletLoiseauFeuille extends javax.swing.JDialog {

    /**
     * Creates new form JDialogVoletLoiseau
     */
    public JDialogVoletLoiseauFeuille(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JDialogVoletLoiseauFeuille(java.awt.Frame parent, boolean modal, Vector<Type_article> v, Vector<Coulisse> c, Vector<Lame> l, Vector<Type_pose> p, Vector<Type_manoeuvre> m, Vector<Couleur> couleur, Vector<String> vol) {
        super(parent, modal);
        initComponents();
        lesTypeVolet = v;
        lesLames = l;
    ...
    private void initComponents() {
        ...
        cbbTypeVolet.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Mozart", "Calyspo", "Traditionnel" }));
    ...
    public static Article_fabrication openForm(Component cpt, Vector<Type_article> v, Vector<Coulisse> c, Vector<Lame> l, Vector<Type_pose> p, Vector<Type_manoeuvre> m, Vector<Couleur> couleur, Vector<String> vol) {
        art = null;
        JDialogVoletLoiseauFeuille volet = new JDialogVoletLoiseauFeuille(null, true, v, c, l, p, m, couleur, vol);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVoletLoiseauFeuille.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVoletLoiseauFeuille dialog = new JDialogVoletLoiseauFeuille(new javax.swing.JFrame(), true);
