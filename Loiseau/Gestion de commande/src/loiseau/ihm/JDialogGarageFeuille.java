 ...
 * @author guillaume
 */
public class JDialogGarageFeuille extends javax.swing.JDialog {

    /**
     * Creates new form JDialogGarage
     */
    public JDialogGarageFeuille(java.awt.Frame parent, boolean modal, Vector<String> v) {
        super(parent, modal);
        initComponents();
        this.v=v;
    }
    ...
    private JDialogGarageFeuille(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        ckbJeuDeCellule.setEnabled(true);
        ckbSystemIO.setEnabled(true);
        if(v.get(0).compareTo("Garage reno")==0){
            cbbNom.setSelectedIndex(0);
        }else{
           cbbNom.setSelectedIndex(1); 
        }
        txtLargeur.setText(v.get(1));
        txtHauteur.setText(v.get(2));

    }//GEN-LAST:event_formWindowOpened

    public static Article_fabrication openForm(Component cpt, Vector<String> v) {
        art = null;
        JDialogGarageFeuille porte = new JDialogGarageFeuille(null, true, v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogGarageFeuille.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogGarageFeuille dialog = new JDialogGarageFeuille(new javax.swing.JFrame(), true);
